...
public:
    ...
    static void drawVector(QPainter *painter, const VectorSettingsGeometry &geomSetttings,
                           float nominalValue, const QVector2D &value, const QColor &color);
private:
    static void drawVectorLine(QPainter *painter, const VectorSettingsGeometry &geomSetttings,
                               float nominalValue, const QVector2D &value, const QColor &color);
    static void drawArrowHead(QPainter *painter, const VectorSettingsGeometry &geomSetttings,
                              float nominalValue, const QVector2D &value, const QColor &color);
